...
static const char CLIENT_HTML[] PROGMEM = R"html(
...
<style>
  ...
  #status, #upProg, #fwProg { font-size: 0.9rem; color: #555; margin-top: 8px; }
</style>
</head><body>
<h1>AuraX</h1>
...
<div style="margin-top:24px;display:flex;align-items:center;gap:8px;flex-wrap:wrap">
  ...
  <button class="save" onclick="updateFw()" style="padding:6px 12px;font-size:0.85rem">Nahrát</button>
  <span id="fwProg" style="font-size:0.85rem;color:#555"></span>
</div>

<p style="margin-top:24px"><a href="/experimental" style="font-size:0.85rem;color:#aaa">&#9881; Experimental</a></p>
...
static const char EXPERIMENTAL_HTML[] PROGMEM = R"html(
<!DOCTYPE html><html><head>
<meta charset="utf-8">
<meta name="viewport" content="width=device-width,initial-scale=1">
...
<p><a href="/" style="font-size:0.85rem;color:#aaa">&#8592; Zpět</a></p>
<h1>AuraX — Experimental</h1>
...
<details>
  ...
  <details style="margin:10px 0">
    ...
    <div class="cfg-grid" style="margin-top:8px">
      ...
      <label style="grid-column:1/-1">Interval m&#283;&#345;en&#237; (ms) <input type="number" name="batIntervalMs" min="100" max="3600000" step="1000" style="width:120px"></label>
