...
private:
    ...
    void blendPixel(uint16_t i, const EffectColor& c, uint8_t scale = 255);
    ...
    void drawSoftSegment(uint32_t startQ8, uint16_t width, const EffectColor& c, uint8_t scale = 255);
